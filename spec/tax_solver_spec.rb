...
RSpec.describe TaxSolver, "#input" do
  context "Use TaxSolver to solver " do
    ...
    it "Input 1:" do
      expect do ts.solve(["2 book at 12.49", "1 music CD at 14.99", "1 chocolate bar at 0.85"]) end.to output(
    ...
    it "Input 2:" do
      expect do ts.solve(["1 imported box of chocolates at 10.00", "1 imported bottle of perfume at 47.50"]) end.to output(
